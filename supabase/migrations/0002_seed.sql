...
('Carla Mendonça','Volta Redonda, RJ',5,'Viagem para Maceió e Maragogi perfeita! Tudo organizado, ônibus confortável e o Renan super atencioso do começo ao fim. Já estamos planejando a próxima viagem com eles!','https://randomuser.me/api/portraits/women/44.jpg',1),
('Roberto Almeida','Barra Mansa, RJ',5,'Família viajou para Gramado com a Renantur. Hotel ótimo, passeios incríveis e atendimento impecável. Preço honesto e tudo dentro do prometido. Recomendo demais!','https://randomuser.me/api/portraits/men/32.jpg',2),
('Fernanda Costa','Resende, RJ',5,'Contratei o pacote para Porto de Galinhas e superou todas as expectativas. Hotel na beira-mar, jangada incluída e guia muito simpático. Voltarei com certeza!','https://randomuser.me/api/portraits/women/68.jpg',3),
('Marcos Souza','Porto Real, RJ',5,'Transfer para o Galeão impecável! Motorista pontual, carro limpo e chegamos com tranquilidade. Serviço de qualidade, preço justo. Uso sempre que viajo.','https://randomuser.me/api/portraits/men/75.jpg',4),
('Ana Paula Ferreira','Volta Redonda, RJ',5,'Fiz o circuito Sul com eles — Gramado, Curitiba e Florianópolis. Que roteiro maravilhoso! Cada detalhe foi pensado. Com certeza a melhor agência do Sul Fluminense.','https://randomuser.me/api/portraits/women/12.jpg',5),
('João Carlos Lima','Quatis, RJ',5,'Cruzeiro pelo litoral sul, tudo perfeito. A Renantur cuidou de todo o processo, desde o embarque até o retorno. Atendimento humano e muito carinho com os clientes.','https://randomuser.me/api/portraits/men/54.jpg',6);
