...
export const destinationData: Record<string, any> = {
  "maceio": {
    name: "Maceió",
...
export type DestinoData = (typeof destinationData)[keyof typeof destinationData];

export function DestinosView({ data }: { data: DestinoData }) {
