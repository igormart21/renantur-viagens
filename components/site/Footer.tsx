...
import { DEFAULT_CITIES, DEFAULT_SETTINGS, type SiteSettings } from "@/lib/site-settings";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-12 xl:gap-16">
          ...
          <div className="xl:col-span-2">
            ...
            <div className="space-y-3 mb-8">
              <a href={settings.whatsapp} className="flex items-center gap-3 text-white/50 hover:text-white text-sm transition-colors group">
                <Phone size={15} className="text-accent" />
                <span>{settings.phone}</span>
              </a>
              <a href={`mailto:${settings.email}`} className="flex items-center gap-3 text-white/50 hover:text-white text-sm transition-colors">
