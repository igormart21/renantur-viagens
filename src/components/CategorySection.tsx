...
const services = [
  {
    label: "01",
    name: "Pacotes Aéreos",
    desc: "Nordeste, Sul e destinos incríveis com tudo incluso.",
    img: "https://images.unsplash.com/photo-1488085061387-422e29b40080?auto=format&fit=crop&q=80&w=900",
    href: "/pacotes",
    accent: "#0F6D7A",
  },
  {
    ...
    desc: "A estrada como parte da experiência. Conforto absoluto.",
    img: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&q=80&w=900",
    href: "/circuitos",
    accent: "#FF6B57",
  },
  {
    label: "03",
    name: "Cruzeiros",
    desc: "Navegue pelo Atlântico com estilo e sem preocupações.",
    img: "https://images.unsplash.com/photo-1548574505-5e239809ee19?auto=format&fit=crop&q=80&w=900",
    href: "/pacotes",
    accent: "#0F6D7A",
  },
  {
    label: "04",
    name: "Internacional",
    desc: "Machu Picchu, Santiago, Buenos Aires e muito mais.",
    img: "https://images.unsplash.com/photo-1587547131116-a0655a526190?auto=format&fit=crop&q=80&w=900",
    href: "/pacotes",
    accent: "#3BB273",
  },
  {
