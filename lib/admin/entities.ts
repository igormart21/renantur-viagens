...
export const ENTITIES: EntityConfig[] = [
  ...
  {
    key: "transfer-galeria",
    table: "transfer_gallery",
    label: "Foto do Transfer",
    labelPlural: "Transfer — Galeria",
    icon: "Images",
    listColumns: ["url", "caption", "active"],
    defaultSort: "sort",
    fields: [
      { key: "url", label: "Imagem", type: "image", required: true },
  ...
  },
  {
    key: "onibus-galeria",
    table: "bus_gallery",
    label: "Foto de Ônibus / Van",
    labelPlural: "Ônibus & Van — Galeria",
    icon: "Images",
    listColumns: ["url", "caption", "active"],
    defaultSort: "sort",
    fields: [
